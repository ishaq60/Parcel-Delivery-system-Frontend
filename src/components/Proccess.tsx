...
export default function ProcessSteps() {
  ...
  return (
    <section
      className="relative w-full py-20 md:py-32 bg-gray-50 overflow-hidden"
    >
      <div className="relative max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#F5A623] to-transparent" style={{opacity: 0.3}}></div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="relative bg-white rounded-2xl p-8 border-2 border-gray-100 hover:border-[#F5A623] transition-all duration-500 hover:shadow-xl hover:shadow-[#F5A623]/20 transform hover:-translate-y-2">
                  {/* Step Number */}
                  ...
                  <div className="mt-8 mb-6 flex justify-center">
                    <div className="w-20 h-20 rounded-2xl bg-[#F5A623]/10 border-2 border-[#F5A623]/30 flex items-center justify-center group-hover:bg-[#F5A623]/20 transition-all group-hover:scale-110 group-hover:rotate-6">
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-[#F5A623] transition-colors">
                      {step.title}
                    </h3>
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden flex justify-center my-6">
                    <div className="w-1 h-10 bg-gradient-to-b from-[#F5A623] to-transparent" style={{opacity: 0.5}}></div>
                  </div>
                )}
              </div>
            )
